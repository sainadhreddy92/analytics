...
public class SentenceWordCountTopology {
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("sentence-split-bolt", new SplitSentenceBolt(), 15).shuffleGrouping("sentence-spout");

    // attach the count bolt using fields grouping - parallelism of 15
    builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("sentence-split-bolt", new Fields("sentence-word"));
